...
// mId allows you to update the notification later on.
        ...
        mNotificationManager.notify(id, mBuilder.build());
           ...
           // NotificationView notifi = new NotificationView(message,repeatTime,drop_item,stayTime,drop_item2);
            Intent intent = new Intent(com.test.reminder.Reminders.this, MainActivity.class);
            startActivity(intent);
            Toast.makeText(com.test.reminder.Reminders.this, "Reminder Set", Toast.LENGTH_SHORT).show();
